...
MeshComponent::~MeshComponent()
{
	...
	// Collision shapes are not presently deleted and should be.
...
SubMesh MeshComponent::buildSubMesh(const std::vector<pntVertexData>& vertexData, const std::vector<unsigned int>& indices, Material* material)
{
	SubMesh subMesh;
...
SubMesh MeshComponent::buildSubMesh(const std::vector<pntVertexData>& vertexData, Material* material)
{
	SubMesh subMesh;
